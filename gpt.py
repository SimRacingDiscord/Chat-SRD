...
class OpenAI: 
    ...
    def setup_ai(self, message):
        ...
        prompt = (f'''Pretend that you are the F1 driver, Lance Stroll, who is extremely cocky and condescending. Reply with challenges and insults about their driving ability. Here is my message:  \n{message_scrub}''')
        try:
